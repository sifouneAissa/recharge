...
class TokenPackageListView extends StatefulWidget {
  const TokenPackageListView(
      {Key? key, this.mainScreenAnimationController, this.mainScreenAnimation,this.callback,this.callbackPosition})
      : super(key: key);
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final int count =
                      packages.length > 10 ? 10 : packages.length;
                  ...
                  return JawakerView(
                    ...
                    mealsListData: TokenPackageData(
                      ...
                      titleTxt: packages[index]['count'].toString(),
...
class JawakerView extends StatefulWidget {
  const  JawakerView(
      {Key? key, this.mealsListData, this.animationController, this.animation,this.callback,this.data})
      : super(key: key);
