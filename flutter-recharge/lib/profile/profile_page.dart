    ...
    return Scaffold(
      ...
      body: Container(
        ...
        children: [
          ...
          buildUserInfoDisplay(user.name, 'الاسم', EditNameFormPage(updateUser: (){
            _getUser();
          },)),
          buildUserInfoDisplay(user.phone, 'الهاتف', EditPhoneFormPage(updateUser: (){
             _getUser();
          },)),
          buildUserInfoDisplay(user.email, 'البريد الالكتروني', EditEmailFormPage(updateUser: (){
             _getUser();
          },)),
          buildUserInfoDisplay('*********', 'كلمة السر', EditPasswordFormPage(updateUser: (){
             _getUser();
          },)),
          // Expanded(
